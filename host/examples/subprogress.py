...
def run_cpp_program():
    cpp_command = "~/文档/uhd/host/build/examples/mytest \
    --tx-freq  5000e6 --tx-rate 200e6 --rx-freq 5000e6 --rx-rate 200e6 \
    --wave-type HELTF20 --wave-freq 2e6 --tx-gain 25 --rx-gain 25 --ampl 0.7 --settling 0.6 \
    --type float --rx-channels 1 --tx-channels 1  --ref internal --tx-bw 160e6 --rx-bw 160e6 \
    --tx-ant TX/RX --rx-ant RX2 --spb 230400  --file \"/mnt/tmp/usrp_160_breathe1.dat\""
