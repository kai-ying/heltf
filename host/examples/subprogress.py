# import subprocess
#
#/bin/python3 /home/dellx/文档/uhd/host/examples/subprogress.py
...
def run_cpp_program():
    cpp_command = "~/文档/uhd/host/build/examples/mytest \
    --tx-freq  5250e6 --tx-rate 200e6 --rx-freq 5250e6 --rx-rate 200e6 \
    --wave-type HELTF160 --wave-freq 2e6 --tx-gain 0 --rx-gain 35 --ampl 0.9 --settling 0.6 \
